        ...
        <div className='p-7 h-screen flex flex-col justify-between'>
            <div>
                ...
                <form onSubmit={submitHandler}>
                    ...
                    <input placeholder='Password' onChange={(e) => { setPassword(e.target.value) }} value={password} className='w-full mb-5 bg-[#eeeeee] rounded border px-4 py-2 text-lg placeholder:text-base' type="password" name="password" id="password" />
                    ...
                    <p className='text-center text-lg'>Already Have Account ?  go to <Link to='/login' className='text-blue-600'>Login</Link> </p>
                </form>
            </div>
            <div>
