...
const WaitingForDriver = (props) => {
  return (
    <div>
      {/* <h5 className='absolute w-full top-0 text-center font-light  mb-2 ' onClick={(e) => { props.setvaichleFoundPanel(false) }}> <i className="ri-arrow-down-wide-line text-4xl text-gray-400"></i></h5> */}
