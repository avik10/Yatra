...
const VaichlePanel = (props) => {
    return (
        <div>
            ...
            <div onClick={(e) => { props.setConfirmRidePanel(true); props.setVechilePanel(false); }} className='flex items-center justify-between p-3 bg-gray-100 border-2 border-gray-300  active:border-black rounded-xl my-2'>
                ...
                <div className=' w-1/2'>
                    <h4 className='font-medium text-lg'>Uber go <span><i className="ri-user-3-fill"></i></span>4</h4>
                    <h5 className='font-medium text-sm'>2 mints away from you</h5>
                    <p className='font-normal text-xs'>Affordable compact rides </p>
                </div>
                <h2 className='text-xl font-semibold'>192.50</h2>
            </div>
